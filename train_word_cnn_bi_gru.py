...
filepath="%s_word_cnn_bi_gru/{epoch:02d}-{loss:.4f}.hdf5" % data_size
...
filename = data_size + '_word_cnn_bi_gru/' + str(d.date()) + '_' + str(d.hour) + '-' + str(d.minute) + '-' + str(d.second) + '_result.tsv'
modelname = data_size + '_word_cnn_bi_gru/' + str(d.date()) + '_' + str(d.hour) + '-' + str(d.minute) + '-' + str(d.second) + '_model.h5'
